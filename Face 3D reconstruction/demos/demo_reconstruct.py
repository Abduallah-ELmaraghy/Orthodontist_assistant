...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--inputpath', default='//content/drive/MyDrive/DECA/TestSamples/examples', type=str,
                        help='path to the test data, can be image folder, image path, image list, video')
    parser.add_argument('-s', '--savefolder', default='/content/drive/MyDrive/DECA/TestSamples/examples/results', type=str,
